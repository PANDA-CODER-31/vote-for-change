...
<body>
    <h1 style="color:mediumturquoise"> </h1>

    <ul style="content:width=device-width;">
        <li><a href="a.php">Home</a> </li>
        <li><a href="d.php">Images</a></li>
        <li><a href="e.php">Results</a></li>
        <li>
            <a href=""></a>
        </li>
    </ul>
    ...
    <body style="background-size: 100%  ;  background-image:url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQI1w0PKj4uwe-xP8ESvzzrdwmnTOpozPaR3w&usqp=CAU);">
        ...
        <div style="position:absolute;   margin-left: 600px;margin-right: 50px; text-align: center;background-color: dimgrey;">
            <form action="signuphelp.php" class="my_form" onsubmit="return check_pass(this);" method="post">
                <fieldset id="b1" class="city">
                    ...
                    <input class="cls" type="tel" id="aadhar" name="aadhar" required><br><br>
                    <label for="state">STATE:</label>
                    <input class="cls" list="state" name="state">
                    <datalist id="state">
        ...
        <img style="width:350px; height:550px; margin-left: 1100px;" src="https://www.newsclick.in/sites/default/files/styles/responsive_885/public/2021-01/Women%20Voter.PNG.webp?itok=f-NxVFnf">
        <script src="index.php"></script>

    </body>
    <script type="text/javascript" language="Javascript">
        function check_pass(my_form) {
            if (my_form.password.value != my_form.pass2.value) {
